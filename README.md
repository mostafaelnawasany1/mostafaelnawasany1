...
- :thinking: I’m searching for  a new challenges [ schedul a meeting ](https://calendly.com/mostafa-hassan-elnawasany), this is [MY RESUME](https://linqapp.com/Home).
...
<script type="text/javascript">window.onload = function() { Calendly.initBadgeWidget({ url: 'https://calendly.com/mostafa-hassan-elnawasany', text: 'Schedule time with me', color: '#0069ff', textColor: '#ffffff', branding: true }); }</script>
